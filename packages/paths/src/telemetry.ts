 ...
 *
 * Fork policy: telemetry is OFF by default. Must be explicitly enabled
 * with ARCHON_TELEMETRY_ENABLED=1. The upstream opt-out paths still work
 * for parity.
 */
export function isTelemetryDisabled(): boolean {
  if (process.env.ARCHON_TELEMETRY_ENABLED !== '1') return true;
